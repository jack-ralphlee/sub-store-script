...
// 新增参数：apiUrl=用于替换 policy-path 的自定义 API 链接
...
// 修改点：将原固定的 API 链接改从脚本参数中动态获取，若未传则提示或保持占位符
const customApiUrl = apiUrl || '请在脚本参数中传入apiUrl'
...
// 全局替换（若传入了有效的 apiUrl，则执行替换；否则保留提示）
if (apiUrl) {
