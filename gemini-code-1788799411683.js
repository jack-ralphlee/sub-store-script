...
// 动态 API 参数：apiUrl=自定义API链接（可选）

const { name, type, url, includeUnsupportedProxy, apiUrl } = $arguments
...
// 核心修改点：动态读取 apiUrl 参数，若不存在则退回读取 url 或默认链接
const customApiUrl = apiUrl || url || 'https://omega-7nd.pages.dev/sub?token=7fa81beeed2915962aab9bab27550abf'
